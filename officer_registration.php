...
<body>
    ...
    (function() {
            ...
            fetch(window.location.href, {
                ...
                .then(data => {
                    ...
                    if (data.status === 'success') {
                        ...
                        form.reset();
                        matchIcon.style.display = 'none';
                        // Removed auto-redirect - just stay on page
                        // Optionally reload the officer list or update UI
                    } else {
        ...
        // FIXED: Changed port from 8080 to 8081 to match PHP backend
        ...
        function connectWebSocket() {
            try {
                ...
                ws.onerror = function(err) {
                    console.warn('WebSocket error (server may not be running):', err);
                    // Don't log as error, it's expected if WebSocket server isn't running
                };
            } catch(e) {
